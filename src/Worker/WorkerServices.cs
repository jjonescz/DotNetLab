...
public static class WorkerServices
{
        ...
        Action<ServiceCollection>? configureServices = null)
    {
        ...
        services.AddScoped<ICompilerDependencyResolver>(sp => sp.GetRequiredService<NuGetDownloaderPlugin>());
        ...
        services.AddScoped<INuGetDownloader>(sp => sp.GetRequiredService<NuGetDownloaderPlugin>());
