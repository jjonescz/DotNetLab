...
{
    private static readonly Formatter defaultFormatter = new IntelFormatter(new FormatterOptions
    {
        HexSuffix = "h",
        OctalSuffix = "o",
        BinarySuffix = "b",
    ...
    private unsafe void PrepareMethod(TextWriter writer, MethodBase methodBase)
    {
        ...
        try
        {
            ...
            {
                MonoJitInspector.WriteDisassembly(methodBase, (byte*)code, size, defaultFormatter, writer);
            }
            else
            {
